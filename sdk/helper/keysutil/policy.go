...
func (p *Policy) DecryptWithFactory(context, nonce []byte, value string, paddingScheme string, factories ...interface{}) (string, error) {
...
func (p *Policy) EncryptWithFactory(ver int, context []byte, nonce []byte, value string, paddingScheme string, factories ...interface{}) (string, error) {
